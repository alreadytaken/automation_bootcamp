...
public class PYSugerenciasPage {
	...
	public String tomarPrecio() {
		String precioSugerencia = driver.findElement(By.xpath(
				"//span[@class=\"promo\" and contains(text(), \"Milanesa completa al pan con papas fritas\")]/..//span[@class=\"after_price\"]"))
