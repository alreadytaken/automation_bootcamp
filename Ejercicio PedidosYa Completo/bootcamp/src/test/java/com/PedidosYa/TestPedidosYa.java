...
public class TestPedidosYa {
	...
	public Object[][] provider() {
		return new Object[][] {
				{ "Nicaragua 1666", "Milanesa", "sebastianrodriguezpaiva@gmail.com", "prueba1234", "Sebastian" } };
	}

	@Test(dataProvider = "direccion")
	public void makeOrder(String direccion, String comida, String usuario, String pass, String nombre)
